...
namespace officeAppUpdate
{
    ...
    //Remove files from destination folder present in tempfolder
    //Move unzipped files to destination folder
    //Remove download file
    //Remove temp folder

    public partial class officeAppUpdate : Form
    {
        bool  called = true;
        ...
        public officeAppUpdate()
        {
            InitializeComponent();
        }

        private  void officeAppUpdate_Load(object  sender, EventArgs  e)
        {
           Hide();
